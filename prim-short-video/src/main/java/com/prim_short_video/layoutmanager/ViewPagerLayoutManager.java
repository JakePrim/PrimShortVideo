...
public abstract class ViewPagerLayoutManager extends LinearLayoutManager {
    ...
    /**
     * Returns the max visible item count, {@link #DETERMINE_BY_MAX_AND_MIN} means it haven't been
     * set now
     * And it will use {@link #maxRemoveOffset()} and {@link #minRemoveOffset()} to handle the
     * range
     *
    ...
    /**
     * Set the max visible item count, {@link #DETERMINE_BY_MAX_AND_MIN} means it haven't been set
     * now
     * And it will use {@link #maxRemoveOffset()} and {@link #minRemoveOffset()} to handle the
     * range
     *
